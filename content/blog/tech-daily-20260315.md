...
- **新增用户规模**：用户增长呈现加速曲线
- **市场竞争力**：在中文llm市场持续霸榜,力压Claude、GPT系列

**分析**：MiniMax凭借在中文场景的深耕和成本优势,正快速蚕食国际llm在中国市场的份额。
...
- **人才引进**：吴永辉（谷歌最高职级L10 Google Fellow）担任llm研发负责人
...
**技术架构**：智谱GLMllm理解指令 → 极豆科技构建车载Agent → 银联通过MCP协议对接支付场景。
