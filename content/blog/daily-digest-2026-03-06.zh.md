...
date: 2026-03-06T06:18:00+08:00
tags: [文章摘要, 日报, ai]
categories: ["技术日报"]
series: []
featured: true
summary: "OpenAI发布GPT-5.4系列新模型,支持百万token上下文窗口 ,AI能力持续迭代；与此同时 ,AI应用的伦理与风险讨论升温,代码重构许可证争议与生成式AI不适用于税务、医疗等高风险场景的警示并存；工程实践层面,代理工程中的代码审查责任与提示工程的局限性也引发开发者反思。"
---
