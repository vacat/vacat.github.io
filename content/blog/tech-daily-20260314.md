...
三月被称为"Agentic AI 主流化之月"。本周三llm发布主导行业格局：
...
- **GigaAI**：1.45亿美元Pre-B轮,专注世界模型人形机器人栈
...
**战略意义**：HONOR将折叠屏的高性能材料与可靠性技术延伸至人形机器人领域,展示具身AI从实验室走向消费端的可行路径。
...
GPT-5.4的原生计算机操作、Phi-4的混合推理架构、GLM-5的开源MoE——llm不再只是"聊天工具",而是具备特定能力的专业Agent。100万token上下文成为旗舰标配,长文档处理、代码库理解等场景将被重新定义。
